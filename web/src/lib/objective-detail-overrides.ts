...
export const OBJECTIVE_DETAIL_OVERRIDES: Record<string, ObjectiveDetailOverride> = {
  ...
  'academic-claim-ladder': {
    goodExample:
      'Good: The paragraph states a local claim, links it to a section-level claim, then ties that to the thesis mechanism, so each inference step is visible and testable.',
    badExample:
      'Needs work: The paragraph jumps from one quote to a broad thesis conclusion with no intermediate warrant, so readers cannot see how the conclusion was earned.',
  },
  'academic-literature-positioning': {
    goodExample:
      'Good: The draft names where it agrees with two prior studies, then marks one methodological disagreement that explains why its conclusion differs in this context.',
    badExample:
      'Needs work: Sources are summarized in sequence, but the writer never states how this paper extends, disputes, or narrows the existing conversation.',
  },
  'academic-significance-lines': {
    goodExample:
      'Good: After presenting evidence, the draft adds a significance line that states who is affected, what decision changes, and why the finding matters now.',
    badExample:
      'Needs work: The section ends after data description, leaving readers unsure what the result changes for policy, practice, or interpretation.',
  },
  'academic-oral-defense': {
    goodExample:
      'Good: Claims are stated with bounded scope, key warrants are explicit, and limits are acknowledged, so the argument can withstand direct questioning.',
    badExample:
      'Needs work: The paper relies on implied logic and vague qualifiers, so basic follow-up questions expose missing warrants and unsupported scope.',
  },
  'academic-final-resonance': {
    goodExample:
      'Good: The ending returns to the thesis mechanism, synthesizes the strongest evidence, and states one durable implication the reader can carry forward.',
    badExample:
      'Needs work: The conclusion repeats earlier wording and stops without synthesis, implication, or a clear final interpretive payoff.',
  },
  'academic-independent-voice': {
    goodExample:
      'Good: Sources are framed briefly, then the writer interprets their tension in original terms, so judgment and argument ownership stay visible.',
    badExample:
      'Needs work: Paragraphs read as stitched source summaries with minimal interpretation, leaving the writer\'s own position hard to identify.',
  },
  'academic-prompt-reading': {
    goodExample:
      'Good: The opening maps each prompt verb to a section task, so the draft directly addresses required analysis, evidence use, and scope limits.',
    badExample:
      'Needs work: The essay treats the topic broadly but misses one required prompt task, so strong prose still fails assignment alignment.',
  },
  'academic-concept-definition': {
    goodExample:
      'Good: The concept is defined with a boundary, a concrete example, and a contrast case, so readers can apply it consistently across the paper.',
    badExample:
      'Needs work: The concept is introduced with abstract wording only, so later claims rely on a term readers cannot reliably interpret.',
  },
  'academic-precision-diction': {
    goodExample:
      'Good: The draft replaces broad terms like \"improves outcomes\" with specific phrasing such as \"reduces first-response time by 18 percent\" in the target cohort.',
    badExample:
      'Needs work: Key lines use vague terms like \"better,\" \"issues,\" and \"important,\" so claims cannot be tested or compared precisely.',
  },
  'academic-style-consistency': {
    goodExample:
      'Good: Terminology, citation format, tense, and heading style stay stable across sections, so readers can focus on argument instead of form drift.',
    badExample:
      'Needs work: The paper switches term labels and citation style midstream, creating avoidable friction and reducing trust in editorial control.',
  },
  'academic-hedging-control': {
    goodExample:
      'Good: The claim is qualified to the sample and method limits, but the central conclusion remains direct, specific, and defensible.',
    badExample:
      'Needs work: Repeated softeners like \"maybe\" and \"possibly\" obscure the main claim, making the argument sound uncertain even where evidence is strong.',
  },
  'academic-active-voice': {
    goodExample:
      'Good: Agency is explicit in key claims (\"the policy committee delayed review\"), while passive voice is used selectively for process emphasis.',
    badExample:
      'Needs work: Responsibility is hidden behind passive chains (\"it was determined\"), so accountability and causal ownership stay unclear.',
  },
  'academic-abstract-noun-control': {
    goodExample:
      'Good: Abstract terms like \"resilience\" are grounded in observable behaviors and context, so readers can evaluate the claim operationally.',
    badExample:
      'Needs work: The paragraph stacks abstractions without concrete indicators, so the argument sounds elevated but remains difficult to verify.',
  },
  'academic-rhythm': {
    goodExample:
      'Good: Sentence lengths vary by function, with short lines landing claim turns and longer lines unpacking evidence links, creating readable analytical cadence across the paragraph.',
    badExample:
      'Needs work: Nearly every sentence has the same long, clause-heavy shape, flattening emphasis and making claim-to-evidence movement harder to follow.',
  },
  'academic-draft-outline': {
    goodExample:
      'Good: The outline lists claim sequence, evidence slots, and transition purpose per section, so drafting follows a clear argumentative path.',
    badExample:
      'Needs work: The outline is topic-only and unordered, so drafting becomes exploratory and key claims emerge too late or not at all.',
  },
  'academic-revision-triage': {
    goodExample:
      'Good: Revision starts with thesis-scope repair, then evidence alignment, then sentence polish, producing visible gains in argument quality.',
    badExample:
      'Needs work: Revision time goes to wording tweaks first, leaving thesis mismatch, evidence misalignment, and structural logic gaps unresolved.',
  },
  'academic-quote-integration': {
    goodExample:
      'Good: The writer introduces the quote with purpose, cites it accurately, and follows with interpretation that links the quote to the claim.',
    badExample:
      'Needs work: The quote is dropped in without framing or analysis, so source text appears but argumentative function remains unclear.',
  },
  'academic-context-use': {
    goodExample:
      'Good: Context lines are brief and immediately tied to the present claim, helping readers interpret evidence without stalling the paragraph.',
    badExample:
      'Needs work: Background expands for several sentences before returning to the claim, diluting pressure and weakening section focus.',
  },
  'academic-source-selection': {
    goodExample:
      'Good: Sources are chosen for direct relevance, methodological fit, and recency, so evidence quality matches claim stakes.',
    badExample:
      'Needs work: The draft relies on tangential or weakly relevant sources, forcing claims to rest on thin support.',
  },
  'academic-source-evaluation': {
    goodExample:
      'Good: Each source is briefly evaluated for method, bias risk, and scope limits before being used as support in the argument.',
    badExample:
      'Needs work: Sources are treated as equally authoritative with no quality checks, so weak evidence enters core claims unchallenged.',
  },
  'academic-citation-discipline': {
    goodExample:
      'Good: Attribution is complete and consistent at every borrowed claim or phrase, letting readers trace evidence without ambiguity.',
    badExample:
      'Needs work: Citations are missing, partial, or inconsistent across paragraphs, making source boundaries, attribution checks, and verification unreliable.',
  },
  'academic-structure-basics': {
    goodExample:
      'Good: The essay moves from framed question to claim, evidence, counterposition, and conclusion in a sequence that compounds understanding.',
    badExample:
      'Needs work: Sections appear in a loose order with repeated points, so readers must reconstruct the argumentative progression themselves.',
  },
  'academic-introduction-function': {
    goodExample:
      'Good: The introduction states question, position, scope, and stakes early, so readers know what the paper will prove and why it matters.',
    badExample:
      'Needs work: The introduction offers broad context only, delaying the thesis and leaving the argument\'s direction unclear.',
  },
  'academic-conclusion-function': {
    goodExample:
      'Good: The conclusion synthesizes the strongest support, reasserts the bounded claim, and states a concrete implication for future decisions.',
    badExample:
      'Needs work: The conclusion merely repeats prior sentences, ending without synthesis, implication, clarified claim scope, or decision guidance.',
  },
  'academic-pivot-control': {
    goodExample:
      'Good: Pivot lines signal exactly why the argument is changing direction, preserving continuity while introducing the new analytic move.',
    badExample:
      'Needs work: Topic shifts happen without a bridge, so readers experience abrupt jumps and lose the logic between sections.',
  },
  'academic-abstract-writing': {
    goodExample:
      'Good: The abstract states research question, method, key finding, and practical implication in compact sequence, allowing quick assessment of contribution and scope.',
    badExample:
      'Needs work: The abstract stays thematic and descriptive, omitting method, key finding, and implication, so contribution remains unclear.',
  },
  'academic-thesis-clarity': {
    goodExample:
      'Good: The thesis states actor, mechanism, and bounded scope in one sentence, giving the essay a debatable and testable center.',
    badExample:
      'Needs work: The central claim remains broad and non-contestable, so body paragraphs lack a precise argument to support.',
  },
  'academic-scope-control': {
    goodExample:
      'Good: The draft explicitly limits population, timeframe, and claim strength, preventing conclusions from outrunning available evidence in the analyzed sample.',
    badExample:
      'Needs work: Scope boundaries are unstated, so claims drift between contexts and overgeneralize beyond what the evidence supports.',
  },
}
